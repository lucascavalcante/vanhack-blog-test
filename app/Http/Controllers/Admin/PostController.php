...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        if($isAdmin) {
            $posts = Post::with(['user', 'category', 'tags', 'comments'])->orderBy('id', 'desc')->paginate(10);
        } else {
            $userId = Auth::user()->id;
            $posts = Post::with(['user', 'category', 'tags', 'comments'])->where('user_id', '=', $userId)->orderBy('id', 'desc')->paginate(10);
        }
